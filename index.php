    ...
    <section class="box-aanbod">
        <div class="container">
            ...
            <div class="tab-aanbod">
                <div class="tab-top">
                    <ul>
                        <li><a href="javascript:void(0)" class="active" data-tab="tab-1">Alles</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-2">Filter 1</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-3">Filter 2</a></li>
                        <li><a href="javascript:void(0)" data-tab="tab-4">Filter 3</a></li>
                    </ul>
                </div>
                <div class="content-tab-aa">
...
<!--                        <input type="submit" value="Neem contact op" class="btn_field">-->
                        <button type="submit" class="btn_field">Neem contact op <img src="images/arrow-right.png" class="img-fluid" alt=""></button>
                    </div>
                </div>
            </div>
        </div>
